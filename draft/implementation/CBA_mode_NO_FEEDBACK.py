...
print("please define pellet price: \n 0 = 1 turn \n 1 = 5 turns \n 2 = 10 turns \n 3 = 25 turns \n 4 = 50 turns \n 5 = 100 turns")
                ...
                if returned_A == False: #if animal has not yet returned from feeding area, perform these functions
                    ...
                    if dtState_A != dtLastState_A: 
                        ...
                        if wheel_counter_A >= limit_A: #when completes 1 full turn (wheel_counter = 1200)
                            ...
                            if (turn_A % int(price) == 0) and (turn_A != 0): #each 10 revolutions
                ...
                if returned_B == False: #if animal has not yet returned from feeding area, perform these functions
                    ...
                    if dtState_B != dtLastState_B: 
                        ...
                        if wheel_counter_B >= limit_B: #when completes 1 full turn (wheel_counter = 1200)
                            ...
                            if (turn_B % int(price) == 0) and (turn_B != 0): #each 10 revolutions
...
def exercise(exercise_key):
    
    if exercise_key == '0':
        return 1
    elif exercise_key == '1':
        return 5
    elif excercise_key == '2':
        return 10
    elif excercise_key == '3':
        return 25
    elif excercise_key == '4':
        return 50
    elif exercise_key == '5':
        return 100
