        ...
        if MODE_A == 2:
            ...
            while MODE_A == 2:
                ...
                if returned_A == False: #if animal has not yet returned from feeding area, perform these functions
                    ...
                    GPIO.output(writeFED_A, True) #as long as the animal has not returned, the Pi will always send signal for the FED to frop the pellet
...
#                         air_puff('A') #delivers air puff to animal
                    ...
                    GPIO.output(writeFED_A, False) #turn FED OFF is animal has returned
        ...
        if MODE_B == 2:
            ...
            while MODE_B == 2:
                ...
                if returned_B == False: #if animal has not yet returned from feeding area, perform these functions
                    ...
                    GPIO.output(writeFED_B, True) #as long as the animal has not returned, the Pi will always send signal for the FED to frop the pellet
...
#                             if turn_B % 1 == 0 and turn_B != 0: #each 10 revolutions
...
#                         air_puff('B') #delivers air puff to animal
                    ...
                    GPIO.output(writeFED_B, False) #turn FED OFF is animal has returned
