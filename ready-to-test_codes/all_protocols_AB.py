...
IDtag_A = ""#define tag ID for mouse A
IDtag_B = ""#define tag ID for mouse B
...
def RFID_check(X, protocol): #define function to check ID of the animal
...
def acquire_weight_pre(X, lines_to_chuck, protocol): #define function to acquire and sotre weight data
...
def acquire_weight_post(X, lines_to_chuck, protocol): #define function to acquire and save weight data
            ...
            if protocol == "OG": #MODE 2 code for the OG protocol
                ...
                while MODE_A == 2:
                    ...
                    if returned_A == False: #if animal has not yet returned from feeding area, perform these functions
                        ...
                        mg_post_mean_A = acquire_weight_post('A', lines_to_chuck, protocol) #acquire weight and assign mean weight value
...
def mouse_B(MODE_B, protocol, wheel_turns_OG, lines_to_chuck, airpuff_time, pellet_price,
    ...
    while True: #infinite loop
        ...
        if MODE_B == 1:
            ser_B.close()
            print("\nMODE_B 1\n")
            mg_pre_mean_B = acquire_weight_pre('B', lines_to_chuck, protocol) #saves the mean weight data
            ...
            if protocol == "OG": #MODE 2 code for the OG protocol
                ...
                while MODE_B == 2:
                    ...
                    if returned_B == False: #if animal has not yet returned from feeding area, perform these functions
                        ...
                        mg_post_mean_B = acquire_weight_post('B', lines_to_chuck, protocol) #acquire weight and assign mean weight value
