        ...
        if MODE_C == 2:
            ...
            while MODE_C == 2:
                ...
                if returned_C == False: #if animal has not yet returned from feeding area, perform these functions
                    GPIO.output(writeFED_C, True) #as long as the animal has not returned, the Pi will always send signal for the FED to drop the pellet
        ...
        if MODE_D == 2:
            ...
            while MODE_D == 2:
                ...
                if returned_D == False: #if animal has not yet returned from feeding area, perform these functions
                    GPIO.output(writeFED_D, True) #as long as the animal has not returned, the Pi will always send signal for the FED to drop the pellet
